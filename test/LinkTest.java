...
class LinkTest {
  ...
  void getLength() {
    ...
    Link link = new RegularLink(city1, city2, cityDistance);
  ...
  void testToString_unsorted() {
    City city1 = new City(city1Name);
    City city2 = new City(city2Name);
    Link link = new RegularLink(city2, city1, cityDistance);
    String expectedString = city1Name + " " + cityDistance + " " + city2Name;
    String resultString = link.toString();
    City.cities.clear();
  ...
  void compareTo_equals() {
    City city1 = new City(city1Name);
    City city2 = new City(city2Name);
    Link link1 = new RegularLink(city1, city2, cityDistance);
    Link link2 = new RegularLink(city1, city2, cityDistance);
    assertEquals(0, link1.compareTo(link2), "compare was not 0");
  }
  ...
  void compareTo_sameCity1() {
    ...
    Link link1 = new RegularLink(city2, city1, cityDistance);
    Link link2 = new RegularLink(city3, city1, cityDistance);
  ...
  void compareTo_sameCity2() {
    ...
    City city3 = new City(city3Name);
    Link link1 = new RegularLink(city1, city2, cityDistance);
    Link link2 = new RegularLink(city1, city3, cityDistance);
    assertTrue(link1.compareTo(link2) < 0, "compare was not negative");
  }
  ...
  void compareTo_differentCities() {
    ...
    City city2 = new City(city2Name);
    City city3 = new City(city3Name);
    Link link1 = new RegularLink(city2, city3, cityDistance);
    Link link2 = new RegularLink(city1, city2, cityDistance);
