...
class CityTest {
  ...
  void find_existsOne() {
    ...
    ICity result = City.find(city1Name);
  ...
  void find_existsTwo() {
    ...
    ICity result = City.find(city2Name);
  ...
  void find_notExistsOne() {
    ...
    ICity result = City.find(city1Name);
    assertTrue(city1Name.equals(result.getName()), "find returned a City with the wrong name");
  ...
  void find_notExistsTwo() {
    ...
    int numCities = City.cities.size();
    ICity result = City.find(city2Name);
    assertTrue(city2Name.equals(result.getName()), "find returned a City with the wrong name");
  ...
  void addLink_empty() {
    ...
    Link link = new RegularLink(city1, city2, cityDistanceShort);
  ...
  void addLink_notEmpty() {
    ...
    /* note: creating the link calls addLink() */
    Link link2 = new RegularLink(city1, city3, cityDistanceLong);
  ...
  void compareTo_xEqual() {
    ...
    assertEquals(0, city1.compareTo(city2), "compareTo was not zero");
  }
  ...
  void getLinksTo_exists() {
    ICity city1 = new City(city1Name);
    ICity city2 = new City(city2Name);
    ILink link = new RegularLink(city1, city2, cityDistanceShort);
    link.setUsed(true);
    Set<ILink> routeLinks = new HashSet<ILink>();
    assertTrue(city1.getLinksTo(city2, routeLinks, null), "getLinkTo returned false when there is a path");
  ...
  @Test
  void getLinksTo_coloured_existed_link(){
    ICity city1 = new City(city1Name);
    ICity city2 = new City(city2Name);
    Link link = new ColouredLink(city1, city2, cityDistanceShort, "red");
    Set<ILink> routeLinks = new HashSet<ILink>();
    assertTrue(city1.getLinksTo(city2 , routeLinks , "red"));
  }

  @Test
  void getLinksTo_coloured_nonExisted_link(){
    ICity city1 = new City(city1Name);
    ICity city2 = new City(city2Name);
    Link link = new RegularLink(city1, city2, cityDistanceShort);
    Set<ILink> routeLinks = new HashSet<>();
    assertTrue(city1.getLinksTo(city2 , routeLinks , null));
  }
